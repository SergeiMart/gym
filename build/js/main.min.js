...
var swiper = new _swiper.default('.coach__swiper', {
...
var getCarousel = new _swiper.default('.feedback__swiper', {
  direction: 'horizontal',
  spaceBetween: 60,
  speed: 1000,
  slidesPerView: 1,
...
var playVideo = document.querySelector('[data-play="button"]');
var player = document.querySelector('[data-player="player"]');
...
},{"./modules/form-validate/form":3,"./modules/init-tabs":9,"./modules/modals/init-modals":10,"./utils/ios-vh-fix":15,"./vendor/swiper":17}],2:[function(require,module,exports){
"use strict";
